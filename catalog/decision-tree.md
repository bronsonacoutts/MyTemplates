...
| A Power Platform ALM/governance starter that grows out of `stampit-ado-governance` | Template | The delivery story centers on ALM docs, release gates, and repo structure. |
