...
| --------------------------------- | ------- | --------------------------------------------------------------------- | ---------------------------------------------- |
| `template.stampit-ado-governance` | Present | Existing in-repo template and the seed for later ALM governance work. | `13-template-power-platform-alm-governance.md` |
...
| `pack.azure-devops-governance` | Present | Azure DevOps governance assets are now grouped around the current stampit implementation.      | `02-shared-packs.md`, `10-governance-retrofit-pack.md` |
...
| `template.power-platform-alm-governance` | Planned | Dedicated ALM and governance template grown from the current stampit seed.                                  | `13-template-power-platform-alm-governance.md` |
