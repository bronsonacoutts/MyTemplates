...
| [13-template-power-platform-alm-governance.md](13-template-power-platform-alm-governance.md) | `future`  | Depends on issues 01, 02, and 04; should also reuse lessons from the existing `commitship-ado-governance` seed. | ALM governance template boundary, differentiators, and seed-to-template migration path are documented. |
